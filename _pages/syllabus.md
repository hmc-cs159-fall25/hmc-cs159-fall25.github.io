...
As for journal writing, similar principles apply. Asking an LLM to completely generate your journal (or large chunks of it) from scratch is a clear Honor Code violation (and defeats the purpose of journaling). On the other hand, if you just wanted to use an AI tool like Grammarly to polish up the wording of a journal that you already wrote in your own words, that may be acceptable as long as you explicitly acknowledge the use of the tool and provide the text of your prompt (if any). That being said, I will point out that the journal is _intended_ to be a "brain dump" of your thoughts and therefore I don't _need_ it to be super polished. It may be preferable (and less work) to turn in an unpolished "raw" journal than to spend unnecessary time prompting an LLM just right to polish it!